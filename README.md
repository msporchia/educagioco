...
| [<img src="docs/img/pozioni-gioco.png" width="200">](docs/pozioni.md) | ### [⚗️ Il laboratorio delle pozioni](docs/pozioni.md)<br>Litri, chili e metri: si dosa con gli attrezzi che si hanno. Una tappa porta **una conversione nuova sola**, e comincia guidata — la dose arriva già convertita, poi con la conversione accanto, poi da sola.<br>*→ [le misure e le conversioni](docs/pozioni.md)* |
