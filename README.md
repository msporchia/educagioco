...
| [<img src="docs/img/fattoria-gioco.png" width="200">](docs/fattoria.md) | ### [🚜 La fattoria](docs/fattoria.md)<br>Dove finiscono le monete guadagnate negli altri giochi: terra da comprare, duecento cose da posare, animali da accudire, e **cinque campi da seminare** che crescono col tempo vero — anche a gioco chiuso, e niente marcisce mai. Il raccolto si macina al mulino o si dà ai **recinti**, che si vede da lontano se hanno fame: ne tornano uova, latte, tartufi e lana. Costa la metà di quello che si compra, e un quarto d'ora di attesa. Non ci sono domande — è il motivo per cui si torna.<br>*→ [la catena, i numeri e cosa manca](docs/fattoria.md)* |
