/* 1 ─ LA COLAZIONE. Il primo episodio della casa di Rosa, ed è
      ...
      **in un posto**, e `chiudi`, perché il cane esiste.
      ...
      ordini su dodici fanno avanzare la colazione; l'ultimo — chiudere
      la porta — non porta niente sul tavolo, e senza di lui si perde
      lo stesso. È il primo piano del gioco in cui una mossa serve a
      difendere quello che hai già fatto, ed è per questo che Bombo non
      morde e non va combattuto: se il cane fosse un nemico da
      attaccare, la lezione sarebbe un'altra.
      ...
      Bombo si muova: non basta chiuderla, va chiusa in tempo. Chi la
      chiude per ultimo, dopo tre viaggi, arriva tardi — ed è l'errore
      che questo livello esiste per far fare una volta.
...
export const COLAZIONE = livello({
  ...
  perde: [se.ha(BOMBO, FARINA)],
  motivoSconfitta: 'Bombo è entrato in casa e si è preso la farina.',
  mostraNemici: true,
