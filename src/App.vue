...
import VerbiGame from './views/VerbiGame.vue'
...
const viste = { home: HomeView, cameretta: RoomView, inglese: EnglishGame, verbi: VerbiGame,
                mate: MathGame, torri: TowerDefense, animali: PetsView }
