/* ═══════════════════════════════════════════════════════════════════
   ...
   Una specie è `{ chiave, emoji, uno, tanti, categoria }`:
...
export const MONDI = {
  prato: {
    ...
    specie: [
      { chiave: 'pecora', emoji: '🐑', uno: 'pecora', tanti: 'pecore', categoria: 'animali' },
      { chiave: 'capra',  emoji: '🐐', uno: 'capra',  tanti: 'capre',  categoria: 'animali' },
      { chiave: 'mucca',  emoji: '🐄', uno: 'mucca',  tanti: 'mucche', categoria: 'animali' },
      { chiave: 'albero', emoji: '🌳', uno: 'albero', tanti: 'alberi', categoria: 'cose' },
      { chiave: 'fiore',  emoji: '🌷', uno: 'fiore',  tanti: 'fiori',  categoria: 'cose' },
      { chiave: 'sasso',  emoji: '🪨', uno: 'sasso',  tanti: 'sassi',  categoria: 'cose' },
    ],
  },
  pollaio: {
    chiave: 'pollaio', nome: 'il pollaio', icona: '🥚', accento: '#ca8a04',
    specie: [
      { chiave: 'gallina', emoji: '🐔', uno: 'gallina', tanti: 'galline', categoria: 'animali' },
      { chiave: 'pulcino', emoji: '🐤', uno: 'pulcino', tanti: 'pulcini', categoria: 'animali' },
      { chiave: 'papera',  emoji: '🦆', uno: 'papera',  tanti: 'papere',  categoria: 'animali' },
      { chiave: 'uovo',    emoji: '🥚', uno: 'uovo',    tanti: 'uova',    categoria: 'cose' },
      { chiave: 'grano',   emoji: '🌾', uno: 'chicco',  tanti: 'chicchi', categoria: 'cose' },
      { chiave: 'cesto',   emoji: '🧺', uno: 'cesto',   tanti: 'cesti',   categoria: 'cose' },
    ],
  },
  stagno: {
    chiave: 'stagno', nome: 'lo stagno', icona: '💧', accento: '#0e9bbd',
    specie: [
      { chiave: 'rana',      emoji: '🐸', uno: 'rana',       tanti: 'rane',        categoria: 'animali' },
      { chiave: 'pesceStagno', emoji: '🐟', uno: 'pesce',    tanti: 'pesci',       categoria: 'animali' },
      { chiave: 'tartaruga', emoji: '🐢', uno: 'tartaruga',  tanti: 'tartarughe',  categoria: 'animali' },
      { chiave: 'foglia',    emoji: '🍃', uno: 'foglia',     tanti: 'foglie',      categoria: 'cose' },
      { chiave: 'sassoStagno', emoji: '🪨', uno: 'sasso',    tanti: 'sassi',       categoria: 'cose' },
      { chiave: 'nuvola',    emoji: '☁️', uno: 'nuvola',     tanti: 'nuvole',      categoria: 'cose' },
    ],
  },
  bosco: {
    chiave: 'bosco', nome: 'il bosco', icona: '🌲', accento: '#166534',
    specie: [
      { chiave: 'volpe',      emoji: '🦊', uno: 'volpe',      tanti: 'volpi',       categoria: 'animali' },
      { chiave: 'cervo',      emoji: '🦌', uno: 'cervo',      tanti: 'cervi',       categoria: 'animali' },
      { chiave: 'scoiattolo', emoji: '🐿️', uno: 'scoiattolo', tanti: 'scoiattoli',  categoria: 'animali' },
      { chiave: 'pino',       emoji: '🌲', uno: 'pino',       tanti: 'pini',        categoria: 'cose' },
      { chiave: 'fungo',      emoji: '🍄', uno: 'fungo',      tanti: 'funghi',      categoria: 'cose' },
      { chiave: 'fogliaSecca', emoji: '🍂', uno: 'foglia secca', tanti: 'foglie secche', categoria: 'cose' },
    ],
  },
  mare: {
    chiave: 'mare', nome: 'il mare', icona: '🌊', accento: '#0369a1',
    specie: [
      { chiave: 'pesceMare', emoji: '🐠', uno: 'pesce',     tanti: 'pesci',     categoria: 'animali' },
      { chiave: 'polpo',     emoji: '🐙', uno: 'polpo',     tanti: 'polpi',     categoria: 'animali' },
      { chiave: 'granchio',  emoji: '🦀', uno: 'granchio',  tanti: 'granchi',   categoria: 'animali' },
      { chiave: 'conchiglia', emoji: '🐚', uno: 'conchiglia', tanti: 'conchiglie', categoria: 'cose' },
      { chiave: 'corallo',   emoji: '🪸', uno: 'corallo',   tanti: 'coralli',   categoria: 'cose' },
      { chiave: 'sassoMare', emoji: '🪨', uno: 'sasso',     tanti: 'sassi',     categoria: 'cose' },
    ],
  },
  ...
  mercato: {
    ...
    specie: [
      { chiave: 'mela',     emoji: '🍎', uno: 'mela',     tanti: 'mele',     categoria: 'cose' },
      { chiave: 'pera',     emoji: '🍐', uno: 'pera',     tanti: 'pere',     categoria: 'cose' },
      { chiave: 'carota',   emoji: '🥕', uno: 'carota',   tanti: 'carote',   categoria: 'cose' },
      { chiave: 'banana',   emoji: '🍌', uno: 'banana',   tanti: 'banane',   categoria: 'cose' },
      { chiave: 'uva',      emoji: '🍇', uno: 'grappolo', tanti: 'grappoli', categoria: 'cose' },
      { chiave: 'pomodoro', emoji: '🍅', uno: 'pomodoro', tanti: 'pomodori', categoria: 'cose' },
    ],
  },
}
