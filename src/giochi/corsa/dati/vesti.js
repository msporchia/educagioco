...
export const VESTI = {
  prato: {
    nome: 'il prato verde', icona: '🌿', accento: '#3fa34d',
  ...
  grano: {
    nome: 'i campi di grano', icona: '🌾', accento: '#d9a441',
  ...
  bosco: {
    nome: 'gli alberi fitti', icona: '🌲', accento: '#2f7d4f',
  ...
  fiume: {
    nome: "l'acqua sotto", icona: '🌉', accento: '#3b8fb0',
  ...
  deserto: {
    nome: 'la sabbia', icona: '🏜️', accento: '#d98a3a',
  ...
  notte: {
    nome: 'il buio', icona: '🌙', accento: '#6f7fd8',
  ...
  neve: {
    nome: 'la neve', icona: '🏔️', accento: '#5f9fd0',
  ...
  lava: {
    nome: 'la lava', icona: '🌋', accento: '#d1522f',
  ...
  cima: {
    nome: 'le nuvole', icona: '⛰️', accento: '#8a6fd0',
