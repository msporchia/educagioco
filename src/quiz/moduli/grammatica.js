...
const COPPIE_GENERE = [
  ...
  { m: 'cane', mp: 'cani', f: 'cagna', fp: 'cagne', em: '🐶' },
  { m: 'gallo', mp: 'galli', f: 'gallina', fp: 'galline', em: '🐓' },
  { m: 'toro', mp: 'tori', f: 'vacca', fp: 'vacche', em: '🐂' },
  { m: 'cavallo', mp: 'cavalli', f: 'cavalla', fp: 'cavalle', em: '🐴' },
  { m: 'elefante', mp: 'elefanti', f: 'elefantessa', fp: 'elefantesse', em: '🐘' },
  { m: 'orso', mp: 'orsi', f: 'orsa', fp: 'orse', em: '🐻' },
  { m: 'lupo', mp: 'lupi', f: 'lupa', fp: 'lupe', em: '🐺' },
  { m: 'sarto', mp: 'sarti', f: 'sarta', fp: 'sarte', em: '✂️' },
  { m: 'pittore', mp: 'pittori', f: 'pittrice', fp: 'pittrici', erroreF: 'pittora', erroreM: 'pittoro', em: '🎨' },
  { m: 'scrittore', mp: 'scrittori', f: 'scrittrice', fp: 'scrittrici', erroreF: 'scrittora', erroreM: 'scrittoro', em: '✍️' },
  { m: 're', mp: 're', f: 'regina', fp: 'regine', erroreM: 'regino', em: '👑' },
  { m: 'eroe', mp: 'eroi', f: 'eroina', fp: 'eroine', em: '🦸' },
  { m: 'marito', mp: 'mariti', f: 'moglie', fp: 'mogli', em: '💍' },
  { m: 'fratello', mp: 'fratelli', f: 'sorella', fp: 'sorelle', em: '👫' },
  { m: 'figlio', mp: 'figli', f: 'figlia', fp: 'figlie', em: '👪' },
  { m: 'cameriere', mp: 'camerieri', f: 'cameriera', fp: 'cameriere', erroreF: 'camerieri', em: '🍽️' },
  { m: 'infermiere', mp: 'infermieri', f: 'infermiera', fp: 'infermiere', erroreF: 'infermieri', em: '👩‍⚕️' },
  { m: 'contadino', mp: 'contadini', f: 'contadina', fp: 'contadine', em: '🧑‍🌾' },
  { m: 'postino', mp: 'postini', f: 'postina', fp: 'postine', em: '📮' },
  { m: 'signore', mp: 'signori', f: 'signora', fp: 'signore', erroreF: 'signori', em: '🎩' },
  { m: 'gigante', mp: 'giganti', f: 'gigantessa', fp: 'gigantesse' },
  { m: 'mago', mp: 'maghi', f: 'maga', fp: 'maghe', em: '🧙' },
  { m: 'pescatore', mp: 'pescatori', f: 'pescatrice', fp: 'pescatrici', erroreF: 'pescatora', erroreM: 'pescatoro', em: '🎣' },
  { m: 'cacciatore', mp: 'cacciatori', f: 'cacciatrice', fp: 'cacciatrici', erroreF: 'cacciatora', erroreM: 'cacciatoro', em: '🏹' },
  { m: 'lettore', mp: 'lettori', f: 'lettrice', fp: 'lettrici', erroreF: 'lettora', erroreM: 'lettoro', em: '📖' },
  { m: 'direttore', mp: 'direttori', f: 'direttrice', fp: 'direttrici', erroreF: 'direttora', erroreM: 'direttoro', em: '🏫' },
...
const PAROLE_PARTI = [
  ...
  { parola: 'quaderno', parte: 'nome', frase: 'Il quaderno è sul tavolo.', aiuto: '«quaderno» è una cosa: le cose sono nomi' },
  { parola: 'zaino', parte: 'nome', frase: 'Lo zaino è pieno di libri.', aiuto: '«zaino» è una cosa: le cose sono nomi' },
  { parola: 'fiore', parte: 'nome', frase: 'Il fiore profuma di primavera.', aiuto: '«fiore» è una cosa: le cose sono nomi' },
  { parola: 'treno', parte: 'nome', frase: 'Il treno parte dal binario due.', aiuto: '«treno» è una cosa: le cose sono nomi' },
  { parola: 'gelato', parte: 'nome', frase: 'Il gelato si sta sciogliendo.', aiuto: '«gelato» è una cosa: le cose sono nomi' },
  { parola: 'nuvola', parte: 'nome', frase: 'La nuvola nasconde il sole.', aiuto: '«nuvola» è una cosa: le cose sono nomi' },
  { parola: 'orologio', parte: 'nome', frase: 'Il mio orologio è rotto.', aiuto: '«orologio» è una cosa: le cose sono nomi' },
  { parola: 'giardino', parte: 'nome', frase: 'Il giardino è pieno di fiori.', aiuto: '«giardino» è un posto: i posti e le cose sono nomi' },
  { parola: 'biscotto', parte: 'nome', frase: 'Il biscotto è nella scatola.', aiuto: '«biscotto» è una cosa: le cose sono nomi' },
  { parola: 'scrive', parte: 'verbo', frase: 'Luca scrive una lettera.', aiuto: '«scrive» dice che cosa fa Luca: è un verbo' },
  { parola: 'ride', parte: 'verbo', frase: 'La bambina ride di gioia.', aiuto: '«ride» dice che cosa fa la bambina: è un verbo' },
  { parola: 'piange', parte: 'verbo', frase: 'Il bambino piange forte.', aiuto: '«piange» dice che cosa fa il bambino: è un verbo' },
  { parola: 'cammina', parte: 'verbo', frase: 'Il cane cammina lentamente.', aiuto: '«cammina» dice che cosa fa il cane: è un verbo' },
  { parola: 'vola', parte: 'verbo', frase: "L'aquilone vola nel cielo.", aiuto: '«vola» dice che cosa fa l\'aquilone: è un verbo' },
  { parola: 'disegna', parte: 'verbo', frase: 'La maestra disegna una casa.', aiuto: '«disegna» dice che cosa fa la maestra: è un verbo' },
  { parola: 'ascolta', parte: 'verbo', frase: 'Il nonno ascolta la radio.', aiuto: '«ascolta» dice che cosa fa il nonno: è un verbo' },
  { parola: 'chiude', parte: 'verbo', frase: 'La porta si chiude piano.', aiuto: '«chiude» dice che cosa fa la porta: è un verbo' },
  { parola: 'parla', parte: 'verbo', frase: 'Il bambino parla piano.', aiuto: '«parla» dice che cosa fa il bambino: è un verbo' },
  { parola: 'caldo', parte: 'aggettivo', frase: 'Il tè è caldo.', aiuto: "«caldo» dice com'è il tè: è un aggettivo" },
  { parola: 'freddo', parte: 'aggettivo', frase: "L'inverno è freddo.", aiuto: "«freddo» dice com'è l'inverno: è un aggettivo" },
  { parola: 'dolce', parte: 'aggettivo', frase: 'Il miele è dolce.', aiuto: "«dolce» dice com'è il miele: è un aggettivo" },
  { parola: 'stanco', parte: 'aggettivo', frase: 'Il bambino è stanco.', aiuto: "«stanco» dice com'è il bambino: è un aggettivo" },
  { parola: 'allegro', parte: 'aggettivo', frase: 'Il clown è allegro.', aiuto: "«allegro» dice com'è il clown: è un aggettivo" },
  { parola: 'pulito', parte: 'aggettivo', frase: 'Il pavimento è pulito.', aiuto: "«pulito» dice com'è il pavimento: è un aggettivo" },
  { parola: 'sporco', parte: 'aggettivo', frase: 'Lo zaino è sporco.', aiuto: "«sporco» dice com'è lo zaino: è un aggettivo" },
  { parola: 'nuovo', parte: 'aggettivo', frase: 'Il quaderno è nuovo.', aiuto: "«nuovo» dice com'è il quaderno: è un aggettivo" },
  { parola: 'vecchio', parte: 'aggettivo', frase: 'Il libro è vecchio.', aiuto: "«vecchio» dice com'è il libro: è un aggettivo" },
  { parola: 'il', parte: 'articolo', frase: 'Ho accarezzato il cane.', aiuto: '«il» sta davanti al nome «cane»: è un articolo' },
  { parola: 'la', parte: 'articolo', frase: 'Guardo la luna di notte.', aiuto: '«la» sta davanti al nome «luna»: è un articolo' },
  { parola: 'un', parte: 'articolo', frase: 'Ho visto un fiore giallo.', aiuto: '«un» sta davanti al nome «fiore»: è un articolo' },
  { parola: 'una', parte: 'articolo', frase: 'Ho visto una farfalla gialla.', aiuto: '«una» sta davanti al nome «farfalla»: è un articolo' },
  { parola: 'lo', parte: 'articolo', frase: 'Ho visto lo scoiattolo sul ramo.', aiuto: '«lo» sta davanti al nome «scoiattolo»: è un articolo' },
  { parola: 'gli', parte: 'articolo', frase: 'Sento gli uccelli cantare.', aiuto: '«gli» sta davanti al nome «uccelli»: è un articolo' },
  { parola: 'il', parte: 'articolo', frase: 'Ho comprato il pane fresco.', aiuto: '«il» sta davanti al nome «pane»: è un articolo' },
  { parola: 'la', parte: 'articolo', frase: 'Ho piantato la rosa in giardino.', aiuto: '«la» sta davanti al nome «rosa»: è un articolo' },
  { parola: 'un', parte: 'articolo', frase: 'Ho preso un gelato al cioccolato.', aiuto: '«un» sta davanti al nome «gelato»: è un articolo' },
  { parola: 'con', parte: 'preposizione', frase: 'Vado a scuola con la mamma.', aiuto: '«con» lega «vado» alla mamma: è una preposizione' },
  { parola: 'su', parte: 'preposizione', frase: 'Il libro è su una mensola.', aiuto: '«su» dice dove sta il libro e lega le parole: è una preposizione' },
  { parola: 'per', parte: 'preposizione', frase: 'Ho comprato un regalo per te.', aiuto: '«per» dice per chi è il regalo e lega le parole: è una preposizione' },
  { parola: 'tra', parte: 'preposizione', frase: "Ci vediamo tra un'ora.", aiuto: '«tra» lega «ci vediamo» a un\'ora: è una preposizione' },
  { parola: 'di', parte: 'preposizione', frase: 'Questo è il gatto di Luca.', aiuto: '«di» dice di chi è il gatto e lega le parole: è una preposizione' },
  { parola: 'da', parte: 'preposizione', frase: 'Vengo da scuola.', aiuto: '«da» dice da dove si viene e lega le parole: è una preposizione' },
  { parola: 'in', parte: 'preposizione', frase: 'Il gatto dorme in cucina.', aiuto: '«in» dice dove dorme il gatto e lega le parole: è una preposizione' },
  { parola: 'in', parte: 'preposizione', frase: 'Il quadro è in salotto.', aiuto: '«in» dice dove sta il quadro e lega le parole: è una preposizione' },
...
const FRASI = [
  ...
  { frase: 'Il pesce nuota veloce.', soggetto: 'Il pesce', predicato: 'nuota', altre: ['veloce'], em: '🐟' },
  { frase: 'La nonna cuce un vestito.', soggetto: 'La nonna', predicato: 'cuce', altre: ['un vestito'], em: '🧵' },
  { frase: 'I cavalli corrono nel prato.', soggetto: 'I cavalli', predicato: 'corrono', altre: ['nel prato'], em: '🐴' },
  { frase: 'Il postino porta le lettere.', soggetto: 'Il postino', predicato: 'porta', altre: ['le lettere'], em: '📬' },
  { frase: 'I bambini disegnano un sole.', soggetto: 'I bambini', predicato: 'disegnano', altre: ['un sole'], em: '🎨' },
  { frase: 'La farfalla vola tra i fiori.', soggetto: 'La farfalla', predicato: 'vola', altre: ['tra i fiori'], em: '🦋' },
  { frase: 'Il fornaio prepara il pane.', soggetto: 'Il fornaio', predicato: 'prepara', altre: ['il pane'], em: '🍞' },
  { frase: 'I nonni raccontano una storia.', soggetto: 'I nonni', predicato: 'raccontano', altre: ['una storia'], em: '📖' },
  { frase: 'Il treno arriva in stazione.', soggetto: 'Il treno', predicato: 'arriva', altre: ['in stazione'], em: '🚂' },
  { frase: 'La maestra scrive alla lavagna.', soggetto: 'La maestra', predicato: 'scrive', altre: ['alla lavagna'], em: '👩‍🏫' },
...
const NOMI_COMUNI = ['bambino', 'cane', 'gatto', 'scuola', 'città', 'fiume', 'montagna', 'maestra', 'pizza', 'gelato', 'albero', 'fiore', 'libro', 'sole', 'mare', 'casa',
  'quaderno', 'penna', 'matita', 'zaino', 'finestra', 'porta', 'sedia', 'tavolo', 'giardino', 'parco', 'spiaggia', 'collina', 'nuvola', 'pioggia', 'vento', 'stella',
  'luna', 'farfalla', 'coniglio', 'tartaruga', 'biscotto', 'formaggio', 'treno']
